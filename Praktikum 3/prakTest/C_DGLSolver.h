...
public:
	...
	void eulerVerfahren(double xStart, double xEnd, double schritte, CMyVektor yStart);
	void heunVerfahren(double xStart, double xEnd, double schritte, CMyVektor yStart);
};
